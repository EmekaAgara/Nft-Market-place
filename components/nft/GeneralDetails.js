  ...
  return (
    <div className={style.wrapper}>
      <div className={style.infoContainer}>
        <div className={style.accent}>Argart NFT Collection</div>
        <div className={style.nftTitle}>{selectedNft?.name}</div>
        <div className={style.otherInfo}>
          <div className={style.ownedBy}>
            Owned by <span className={style.accent}>realagara</span>
          </div>
          <div className={style.likes}>
            <AiFillHeart className={style.likeIcon} /> 1.7K favorites
          </div>
        </div>
      </div>
